...
const IncidentCard = ({ 
  ...
  const getCategoryConfig = (cat) => {
    const configs = {
      'Medical': { color: '#3b82f6', bg: 'linear-gradient(135deg, #3b82f6, #1d4ed8)', icon: '🏥' },
      'Fire': { color: '#ef4444', bg: 'linear-gradient(135deg, #ef4444, #dc2626)', icon: '🔥' },
      'Security': { color: '#f59e0b', bg: 'linear-gradient(135deg, #f59e0b, #d97706)', icon: '🔐' },
      'Technical': { color: '#8b5cf6', bg: 'linear-gradient(135deg, #8b5cf6, #7c3aed)', icon: '⚙️' },
      'Hazard': { color: '#ec4899', bg: 'linear-gradient(135deg, #ec4899, #db2777)', icon: '⚠️' },
      'Traffic': { color: '#06b6d4', bg: 'linear-gradient(135deg, #06b6d4, #0891b2)', icon: '🚗' },
      'Flood': { color: '#0ea5e9', bg: 'linear-gradient(135deg, #0ea5e9, #0284c7)', icon: '🌊' },
      'Other': { color: '#6b7280', bg: 'rgba(107,114,128,0.2)', icon: '📋' }
    };
      ...
      <div style={{ 
        ...
        <div style={{ flex: 1, paddingRight: '16px' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: '14px' }}>{categoryConfig.icon}</span>
            <span>{category}</span>
          </div>
